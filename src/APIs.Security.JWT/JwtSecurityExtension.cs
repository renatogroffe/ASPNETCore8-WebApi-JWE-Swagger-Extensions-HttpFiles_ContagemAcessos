...
public static class JwtSecurityExtension
{
        ...
        TokenConfigurations tokenConfigurations)
    {
        ...
        // JWE
        var tokenDecryptionKey = new SymmetricSecurityKey(
            Encoding.UTF8.GetBytes(tokenConfigurations.TokenDecryptionKey!));
        var encryptingCredentials = new EncryptingCredentials(
            tokenDecryptionKey,
            SecurityAlgorithms.Aes128KW,
            SecurityAlgorithms.Aes128CbcHmacSha256);
        services.AddSingleton(encryptingCredentials);
        ...
        }).AddJwtBearer(bearerOptions =>
        {
            ...
            // JWE
            paramsValidation.TokenDecryptionKey = tokenDecryptionKey;
